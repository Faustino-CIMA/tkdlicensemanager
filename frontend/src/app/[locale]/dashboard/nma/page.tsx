...
import { Club, License, Member, getClubs, getLicenses, getMembers } from "@/lib/nma-admin-api";

export default function NmaAdminOverviewPage() {
  ...
  return (
    <NmaAdminLayout title={t("overviewTitle")} subtitle={t("overviewSubtitle")}>
