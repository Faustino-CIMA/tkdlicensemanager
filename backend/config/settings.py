...
MIN_PHOTO_UPLOAD_LIMIT_BYTES = 25 * 1024 * 1024
DATA_UPLOAD_MAX_MEMORY_SIZE = max(
    config("DATA_UPLOAD_MAX_MEMORY_SIZE", cast=int, default=MIN_PHOTO_UPLOAD_LIMIT_BYTES),
...
CARD_SVG_ALLOWED_CSS_PROPERTIES = (
    "fill",
    "stroke",
    "stroke-width",
    "opacity",
